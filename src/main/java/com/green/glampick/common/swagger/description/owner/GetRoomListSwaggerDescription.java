...
public class GetRoomListSwaggerDescription {
    public static final String GET_ROOM_LIST_DESCRIPTION =

            "<strong>로그인한 사장이 객실 리스트를 불러옵니다.</strong>" +
                    "<p>로그인이 필요한 기능입니다. 상단 Authorize 에 토큰값을 입력 후 이용해주세요.</p>" +
                    "<p>-------------------------------------------------</p>" +
                    "<p>glampId : 글램핑 PK (필수)</p>"
            ;

    public static final String GET_ROOM_LIST_RESPONSE_ERROR_CODE =
